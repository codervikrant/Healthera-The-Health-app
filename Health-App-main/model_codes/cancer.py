...
df = pd.read_csv(r"C:\Users\Dell\Desktop\healthy\Health-App-main\data\cancer.csv")
...
joblib.dump(model,r"C:\Users\Dell\Desktop\healthy\Health-App-main\Breast_Cancer API\cancer_model.pkl")
